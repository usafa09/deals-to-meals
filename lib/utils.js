...
export const REDIRECT_URI     = "https://dealstomeals.co/auth/kroger/callback";
export const APP_URL          = "https://dealstomeals.co";
...
// Spoonacular point tracking
export let dailyPoints = 0;
export let pointsResetDate = new Date().toDateString();
export const DAILY_POINT_LIMIT = 180;
export const POINTS_PER_SEARCH = 3;

export function addDailyPoints(n) { dailyPoints += n; }
export function resetDailyPoints() { dailyPoints = 0; pointsResetDate = new Date().toDateString(); }
export function getDailyPoints() { return dailyPoints; }
export function getPointsResetDate() { return pointsResetDate; }
...
// ── Spoonacular helpers ─────────────────────────────────────────────────────
export function checkAndResetPoints() {
