...
export const KROGER_FAMILY_BRANDS = new Set(["kroger","ralphs","fred meyer","fry's","fry's food","harris teeter","king soopers","smith's","smiths","qfc","mariano's","marianos","pick 'n save","pick n save","metro market","dillons","baker's","bakers","pay less","gerbes","jay c","food 4 less","foods co","owen's","city market"]);
export function isKrogerFamilyBrand(name) { return KROGER_FAMILY_BRANDS.has((name||"").toLowerCase()); }
